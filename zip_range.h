...
namespace range_utils {
    ...
    public:
        ...
        class iterator_t {
            ...
            using iterator_tuple = std::tuple<ranges::iterator_t<R>...>;
            ...
            static constexpr bool bidirectional =
                std::conjunction<std::integral_constant<bool,
                ranges::bidirectional_range<R>>...>::value;
        ...
        public:
            ...
            using value_type = std::tuple<ranges::range_reference_t<R>...>;
            using reference_type = std::tuple<ranges::range_reference_t<R>...>;
...
template <class... Args>
struct ranges::ext::enable_view<range_utils::zip_range<Args...>> {
